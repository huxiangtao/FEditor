...
import { CANVAS_LEFT_MARGIN } from "./constants";
import "./style.css";
...
const regularShapes = [
  {
    tag: "rect",
    id: "create-rect",
    attributes: { x: 2, y: 10, width: 31, height: 16, ...commonProps }
  },
  {
    tag: "path",
    id: "create-triangle",
  ...
  },
  {
    tag: "ellipse",
    id: "create-circle",
    attributes: { cx: "18", cy: "18", rx: "15.6", ry: "15.6", ...commonProps }
  },
  {
    tag: "path",
    id: "create-star",
    attributes: {
      d:
        "M17.45 1.5l4 11.33h12l-9.33 7.33 3.33 11.34-10-6.67-10 6.67 3.33-11.33-9.33-7.34h12z",
      ...commonProps
    }
  },
  {
  ...
  },
  {
    ...
    attributes: {
      d:
        "M 10 13 C 4 13 2 18 7 19 C 2 21 8 26 12 24 C 15 28 24 28 27 24 C 34 24 34 20 30 18 C 34 14 27 10 22 12 C 18 9 12 9 10 13 Z",
      ...commonProps
    }
  },
  {
    tag: "path",
    id: "create-cubicBezier",
    attributes: {
      d: "M 4 34 Q 33 34 18 19 Q 4 4 29 4",
      strokeMiterlimit: "10",
      ...commonProps,
      fill: "none"
    }
