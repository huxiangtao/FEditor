module.exports = {
  ...
  SCALE_HANDLER_WIDTH: 18,
  CONTROL_POINT_HANDLER_WIDTH: 18,
  SCALE_HANDLER_DATA:
  ...
  ROTATE_HANDLER_WIDTH: 19,
  ROTATE_HANDLER_HEIGHT: 21,
  ROTATE_HANDLER_MARGIN: 22, // the margin between the shape and its above rotate handler

  TEXT_ELE_WIDTH: 80, // the default width of attached text
  TEXT_ELE_HEIGHT: 40, // ...........height ................, both are used to calculate the attached text's absolute position inside the enclosing shape

  ARROW_WIDTH: 32,
  ARROW_HEIGHT: 16,
  MARKER_ARROW_WIDTH: 12,
  ...
  CHAT_INPUT_BOX_HEIGHT: 134, // the input box height plus the height of emoji icon
